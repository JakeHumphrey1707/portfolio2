  ...
  return (
    ...
    <F duration={2000}>
      <div className='grid grid-cols-4 w-full h-full backgroundimage'>
        <div className='md:p-20 p-4 md:pl-16 ml-auto space-y-12 text-lg md:text-2xl text-left justify-center z-50 flex flex-col col-span-1 md:col-span-2'>
          <div className=''>
            <F duration={3000}>
        ...
        <div className='w-full h-full z-10 col-span-3 md:col-span-2'><F duration={5000}>{renderComponent()}</F></div>
      </div>
      </F>
    </div>
  );
